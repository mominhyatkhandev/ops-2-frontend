...
const MiniApps = (): JSX.Element => {
  return (
    <div id="NewRootRoot" className="flex flex-col w-full mb-[20px]">
      ...
      <div className="min-h-[640px] flex flex-col justify-center shrink-0 px-[254px] py-[156px] items-center relative">
        <Image
          src={miniApps}
        ...
        />
        <div className="shadow-[0px_4px_16px_0px_rgba(51,_51,_51,_0.08)] bg-neutral-white-base flex flex-col justify-center gap-16 shrink-0 items-center p-10 rounded-lg relative">
          <div
            id="MiniApps1"
