...
const PaymentLink = (): JSX.Element => {
  return (
    <div id="NewRootRoot" className="flex flex-col w-full">
      ...
      <div className="min-h-[640px] flex flex-col justify-end shrink-0 items-end pr-40 py-24 relative">
        <Image
          src={paymentLink}
        ...
        <div className="shadow-[0px_4px_16px_0px_rgba(51,_51,_51,_0.08)] bg-neutral-white-base max-w-[560px] flex flex-col justify-center py-[40px] px-[32px] gap-12 shrink-0 items-start rounded-lg relative">
          <div
            id="PaymentLink1"
            className="text-5xl leading-tight font-semibold text-secondary-base"
          >
