...
const Navbar = () => {
  return (
    <div className="w-auto h-[82px] flex items-center justify-between bg-neutral-white-base shadow-[0px_2px_6px_0px_rgba(51,_51,_51,_0.08)] py-[24px] px-[150px] relative">
