...
const Dropdown = ({ isHovered, setSelectedOption }: IDropdownProps) => {
  ...
  return (
    <>
      {isHovered && (
        <div className="absolute top-20 left-0 shadow-md p-[24px] bg-neutral-white-base flex flex-col justify-start gap-6 w-[225px] items-start rounded-lg z-10">
...
{
  /* //     <Link href="/">
        //       <div className="flex flex-row gap-4 items-start hover:text-primary-base hover:transition duration-300">
        //         <Image src={Scanner} width={24} height={24} alt="coin" />
        //         <span>QR Payments</span>
        //       </div>
        //     </Link>
        //     <Link href="/">
        //       <div className="flex flex-row gap-4 items-start hover:text-primary-base">
